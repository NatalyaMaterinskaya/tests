...
})({"5WkMt":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "338df6a83c103278";
"use strict";
...
},{}],"awC2T":[function(require,module,exports) {
var _questionsTask12 = require("./questions-task-12");
var _common = require("../js/common");
var _createMarkup = require("../js/helpers/create-markup");
var _createButtonMarkupForTwelfthTest = require("./create-button-markup-for-twelfth-test");
...
(0, _createQuestionId.createQuestionId)((0, _questionsTask12.testItems));
const markup = (0, _createMarkup.createMarkup)((0, _questionsTask12.testItems));
let counter = null;
let numQuestion = 1;
(0, _common.testsEl).innerHTML = markup[numQuestion - 1];
const buttonMarkup = (0, _createButtonMarkupForTwelfthTest.createButtonMarkup)().join("");
...
},{"./questions-task-12":"9Yc2j","../js/common":"2ASYY","../js/helpers/create-markup":"eLGg5","./create-button-markup-for-twelfth-test":"ktsP8","../js/helpers/get-current-date":"gTe1R","../js/helpers/create-question-id":"ipKyU"}],"9Yc2j":[function(require,module,exports) {
...
const testItems = [
    ...
    {
        question: "Чи виникала потреба в останні 12 місяців грати на більшу суму, щоб досягти того рівня збудження, якого ви хотіли?"
    },
    {
        question: "Чи поверталися на наступний після програшу день до гри, щоб відіграти програні гроші?"
    },
    {
        question: "Чи позичали ви колись гроші, чи продавали майно, щоб мати можливість грати чи відігратись?"
    },
    {
        question: "Чи відчували ви коли-небудь, що у вас можуть бути проблеми з азартними іграми?"
    },
    {
        question: "Чи була колись азартна гра причиною ваших проблем зі здоров’ям, включаючи стрес і безпричинне занепокоєння?"
    },
    {
        question: "Чи критикували вас за вашу пристрасть до азартних ігор, чи казали вам, що у вас проблеми з азартними іграми, незалежно від того, чи вважали ви ці зауваження справедливими?"
    },
    {
        question: "Чи колись ваша пристрасть до азартних ігор була причиною фінансових проблем для вас чи вашої родини?"
    },
    {
        question: "Чи відчували ви колись провину за те, як ви граєте, або за те, що відбувається під час гри?"
    }
];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ktsP8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function createButtonMarkup() {
    let markup = [];
    for(let i = 0; i <= 3; i += 1)markup.push(`<li class="btn-item">
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5WkMt","awC2T"], "awC2T", "parcelRequiree8da")

//# sourceMappingURL=task-12.3c103278.js.map
