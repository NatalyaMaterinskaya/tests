const firstBlockItems = [
  ...
  },
  {
    id: 1.10,
    question:
      "Рівень довіри до командування оперативного (повітряного) командування.",
  },
  {
    id: 1.11,
...
export { firstBlockItems, secondBlockItems, thirdBlockItems, fourthBlockItems, fifthBlockItems, sixthBlockItems };