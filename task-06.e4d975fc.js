...
})({"iDexr":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ab03f5b1e4d975fc";
"use strict";
...
},{}],"99XWI":[function(require,module,exports) {
var _questions = require("./js/questions");
var _createMarkupForSixthTest = require("./js/helpers/create-markup-for-sixth-test");
...
const markup = (0, _createMarkupForSixthTest.createMarkupForSixthTest)((0, _questions.sixthTestItemsRightCharacteristics));
...
const clickItem = (evt)=>{
    ...
    if (numQuestion <= markup.length) switch(target.dataset.state){
        case "true":
    ...
    <p class="result"> Результат = ${trueCaseCounter + falseCaseCounter / 80 * 100} </p>`;
...
},{"./js/questions":"9rgTG","./js/helpers/create-markup-for-sixth-test":"avY9q","./js/common":"2ASYY","./js/helpers/get-current-date":"gTe1R"}],"avY9q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createMarkupForSixthTest", ()=>createMarkupForSixthTest);
function createMarkupForSixthTest(arr) {
    const markup = arr.map(({ id, question, state })=>`<li class="test-item">
