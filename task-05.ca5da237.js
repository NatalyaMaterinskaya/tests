var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},e={},n={},s=t.parcelRequiree8da;null==s&&((s=function(t){if(t in e)return e[t].exports;if(t in n){var s=n[t];delete n[t];var l={id:t,exports:{}};return e[t]=l,s.call(l.exports,l,l.exports),l.exports}var a=Error("Cannot find module '"+t+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(t,e){n[t]=e},t.parcelRequiree8da=s);var l=s("fMoMY");function a(t){for(let e=1;e<=t.length;e+=1)t[e-1].id=e}var i=s("h6ark"),r=s("gtiYd");const u=document.querySelector(".container"),o=document.querySelector(".title"),c=document.querySelector(".left-wrapper"),d=document.querySelector(".right-wrapper");a(l.fifthTestItemsLeftCharacteristics),a(l.fifthTestItemsRightCharacteristics);const b=function(t){let e=t.map(({id:t,question:e})=>`<li class="test-item">
  ...
  </li>`);return e}(l.fifthTestItemsRightCharacteristics);let f=0,m=0,h=0,y=1,g=null;const $=[1,2,7,8,13,14,19,20,25,26],v=[3,4,9,10,15,16,21,22,27,28],L=[5,6,11,12,17,18,23,24,29,30];alert("Інструкція: Вам необхідно співвіднести свій стан із рядом ознак за багатоступінчастою шкалою. Шкала складається з індексів (3 2 1 0 1 2 3) і розташована між тридцятьма парами слів протилежного значення, які відображають рухливість, швидкість і темп перебігу функцій (активність), силу, здоров’я, стомленість (самопочуття), а також характеристики емоційного стану (настрій). Ви маєте вибрати і позначити цифру, яка найточніше відображає Ваш стан у момент обстеження. !!!При цьому потрібно враховувати, що полюси шкал (негативний і позитивний) постійно змінюються!!!");const T=t=>{let{target:e}=t;if(e.classList.contains("btn")){if(y<=b.length)switch(e.dataset.state){case"true":$.includes(y)&&(f+=4+Number(e.textContent)),v.includes(y)&&(m+=4+Number(e.textContent)),L.includes(y)&&(h+=4+Number(e.textContent));break;case"false":$.includes(y)&&(f+=4-Number(e.textContent)),v.includes(y)&&(m+=4-Number(e.textContent)),L.includes(y)&&(h+=4-Number(e.textContent));break;default:console.log("Полюс питання відсутній!")}if(y<b.length){c.innerHTML=b[y],d.innerHTML=p[y];let t=d.firstElementChild;t.addEventListener("click",T),y+=1}else{let t=(0,r.getCurrentDate)();u.classList.remove("column-wrapper");let e=`<p class="user"> Тест пройшов</p>
    <p class="user">${g}</p>
